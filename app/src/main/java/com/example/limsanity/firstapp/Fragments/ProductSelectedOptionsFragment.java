...
public class ProductSelectedOptionsFragment extends DialogFragment implements View.OnClickListener {
    Context mContext;
    View panel;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog_product_selected, container);
    ...
    public void onClick(View view) {
        ...
        panel.postDelayed(new Runnable() {
            @Override
            public void run() {
                ProductSelectedOptionsFragment.this.dismiss();
            }
        }, 300);
    }
}
